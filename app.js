(() => {
  ...
  function Footer({ gpuM }) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("footer", { style: { textAlign: "center", padding: "4rem 1.5rem 8rem", borderTop: "1px solid var(--border)", background: "var(--bg2)" } }, /* @__PURE__ */ React.createElement("p", { style: { color: "var(--muted)", fontSize: ".88rem", marginBottom: "1.2rem", lineHeight: "1.6" } }, "\xA9 ", (/* @__PURE__ */ new Date()).getFullYear(), " Mohammad Taha Majlesi. Open-Source AI Infrastructure & Frontier Research."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "1.4rem", justifyContent: "center", flexWrap: "wrap", fontSize: ".88rem" } }, /* @__PURE__ */ React.createElement("a", { href: "https://github.com/tahamajs", target: "_blank", rel: "noreferrer", style: { color: "#fff" } }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-github" }), " GitHub (@tahamajs)"), /* @__PURE__ */ React.createElement("a", { href: "https://huggingface.co/tahamajs", target: "_blank", rel: "noreferrer", style: { color: "#ffd21e" } }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-robot" }), " HuggingFace (162 Assets)"), /* @__PURE__ */ React.createElement("a", { href: "https://hooshaai.substack.com", target: "_blank", rel: "noreferrer", style: { color: "#ff6719" } }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-newspaper" }), " Hoosha AI Substack"), /* @__PURE__ */ React.createElement("a", { href: "https://linkedin.com/in/tahamajlesi", target: "_blank", rel: "noreferrer", style: { color: "#0a66c2" } }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-linkedin" }), " LinkedIn (17.1k)"), /* @__PURE__ */ React.createElement("a", { href: "https://instagram.com/hooshaaii", target: "_blank", rel: "noreferrer", style: { color: "#e1306c" } }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-instagram" }), " Instagram (@hooshaaii)"), /* @__PURE__ */ React.createElement("a", { href: "https://t.me/tahamajlesii", target: "_blank", rel: "noreferrer", style: { color: "#229ed9" } }, /* @__PURE__ */ React.createElement("i", { className: "fab fa-telegram" }), " Telegram (@tahamajlesii)"), /* @__PURE__ */ React.createElement("a", { href: "https://github.com/sponsors/tahamajs", target: "_blank", rel: "noreferrer", style: { color: "#ea4aaa", fontWeight: 600 } }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-heart" }), " Sponsor Research"))), /* @__PURE__ */ React.createElement("div", { className: "gpu-bar" }, /* @__PURE__ */ React.createElement("div", { className: "gpu-dot" }), /* @__PURE__ */ React.createElement("div", { className: "gpu-item" }, "Node: ", /* @__PURE__ */ React.createElement("b", null, "A100-SXM4-80GB")), /* @__PURE__ */ React.createElement("div", { className: "gpu-item" }, "SM Util: ", /* @__PURE__ */ React.createElement("span", { className: "gpu-val" }, gpuM.util, "%")), /* @__PURE__ */ React.createElement("div", { className: "gpu-item" }, "VRAM: ", /* @__PURE__ */ React.createElement("span", { className: "gpu-val" }, gpuM.vram, " GB"), " / 80.0"), /* @__PURE__ */ React.createElement("div", { className: "gpu-item" }, "Bandwidth: ", /* @__PURE__ */ React.createElement("span", { className: "gpu-val" }, "1.8 TB/s")), /* @__PURE__ */ React.createElement("div", { className: "gpu-item" }, "TFLOPS: ", /* @__PURE__ */ React.createElement("span", { className: "gpu-val" }, gpuM.flops)), /* @__PURE__ */ React.createElement("div", { className: "gpu-item" }, "Temp: ", /* @__PURE__ */ React.createElement("span", { className: "gpu-val" }, gpuM.temp, "\xB0C"))));
  }

  // src/components/ui/FloatingContactBar.jsx
  function FloatingContactBar({ onHire, onCopyEmail, onTelegramBot, onBookCall, onAuth, userProfile, beep, showToast }) {
    return /* @__PURE__ */ React.createElement("div", { className: "floating-contact-bar" }, /* @__PURE__ */ React.createElement("div", { className: "floating-contact-inner" }, /* @__PURE__ */ React.createElement("button", { className: "floating-contact-btn primary", onClick: () => {
      ...
      onBookCall?.();
      beep?.(880);
    }, title: "Schedule 1-on-1 Call with Taha" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-calendar-alt", style: { color: "var(--emerald)" } }), " ", /* @__PURE__ */ React.createElement("span", null, "Book 1-on-1 Call")), /* @__PURE__ */ React.createElement("button", { className: "floating-contact-btn", onClick: () => {
      onCopyEmail();
      beep?.(700, "square");
  ...
  function HeroSection({ time, onHire, onAI, onSponsor, setSearch, scrollTo, beep }) {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "hero-badge" }, /* @__PURE__ */ React.createElement("span", { className: "dot" }), "Co-Founder & AI Architect @ Hoosha AI \u{1F9E0} \xB7 Self-Made Public School Student (\u0645\u062F\u0631\u0633\u0647 \u062F\u0648\u0644\u062A\u06CC)"), /* @__PURE__ */ React.createElement("div", { className: "hero-clock" }, "Tehran: ", /* @__PURE__ */ React.createElement("b", null, time), " (UTC +3:30) \xA0\xB7\xA0", /* @__PURE__ */ React.createElement("span", { className: "status-green" }, "\u2B24 Open to Roles & Collaboration")), /* @__PURE__ */ React.createElement("h1", { className: "hero-title" }, "Mohammad Taha Majlesi", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { className: "gradient-text" }, "AI Systems Engineer & Researcher")), /* @__PURE__ */ React.createElement("p", { className: "hero-subtitle" }, "Building scalable AI systems and distributed GPU infrastructure. Co-Founder of ", /* @__PURE__ */ React.createElement("b", null, "Hoosha AI \u{1F9E0}"), " \xB7 ", /* @__PURE__ */ React.createElement("b", null, "17.1k+ LinkedIn community"), " \xB7 CE student at ", /* @__PURE__ */ React.createElement("b", null, "University of Tehran"), " \xB7 TA for Compiler Construction at ", /* @__PURE__ */ React.createElement("b", null, "Sharif University"), ".", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)", fontWeight: 600 } }, "\u{1F393} Self-Made Journey: Graduated from a Public State High School (\u0645\u0646 \u0627\u0632 \u0645\u062F\u0631\u0633\u0647 \u062F\u0648\u0644\u062A\u06CC \u0627\u0648\u0645\u062F\u0645 \u2014 Never studied at Helli or SAMPAD selective magnet schools).")), /* @__PURE__ */ React.createElement("div", { className: "tag-cloud" }, TAGS.map((tag) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: tag,
        className: "tag-pill",
...
[STATUS]   Synthetic Cognition Module is Integrated (\u03A6 > 0.0) \u2713`
  ...
  function ProjectsSection({ repos, search, setSearch, filter, setFilter, hfAssets, hfFilter, setHfFilter, counts, articles, subSearch, setSubSearch, beep }) {
    return /* @__PURE__ */ React.createElement("section", { id: "projects", className: "section fade-up" }, /* @__PURE__ */ React.createElement(
      ...
      setFilter("ai");
      beep?.(600);
    } }, "ML & Generative AI (", counts.ai || counts.ml || 42, ")"), /* @__PURE__ */ React.createElement("button", { className: `filter-btn ${filter === "systems" ? "active" : ""}`, onClick: () => {
      setFilter("systems");
      beep?.(600);
      ...
      setHfFilter("all");
      beep?.();
    } }, "All Assets (162)"), /* @__PURE__ */ React.createElement("button", { className: `filter-btn ${hfFilter === "model" || hfFilter === "Model" ? "active" : ""}`, onClick: () => {
      setHfFilter("model");
      beep?.();
    } }, "Models (92)"), /* @__PURE__ */ React.createElement("button", { className: `filter-btn ${hfFilter === "dataset" || hfFilter === "Dataset" ? "active" : ""}`, onClick: () => {
      setHfFilter("dataset");
      beep?.();
  ...
  function NewsletterSection({ beep, showToast }) {
    ...
    const handleSubmit = (e) => {
      ...
      beep?.(880, "sine");
      setSubscribed(true);
      showToast?.(`\u{1F4E7} Subscribed ${email} to Hoosha AI Substack! Check your inbox.`);
    };
    return /* @__PURE__ */ React.createElement("section", { id: "newsletter", className: "section fade-up", style: { background: "rgba(0,240,255,0.01)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" } }, /* @__PURE__ */ React.createElement(
      SectionHead,
      {
        tag: "Join 17,100+ Readers",
        title: "Get Deep-Dive AI Engineering Essays \u{1F9E0}",
    ...
    ), /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 640, margin: "0 auto", textAlign: "center" } }, !subscribed ? /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, className: "newsletter-form", style: { display: "flex", gap: ".8rem", flexWrap: "wrap", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "email",
        required: true,
  ...
  function ContactSection({ onHire, beep }) {
    ...
    return /* @__PURE__ */ React.createElement("section", { id: "contact", className: "section fade-up" }, /* @__PURE__ */ React.createElement(
      ...
      onHire();
      beep?.();
    } }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-briefcase" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", null, "Recruit / Hire Taha"), /* @__PURE__ */ React.createElement("p", null, "Full-time, part-time, contract, or research collaboration")), /* @__PURE__ */ React.createElement("i", { className: "fas fa-arrow-right", style: { marginLeft: "auto", opacity: 0.6 } })), /* @__PURE__ */ React.createElement("a", { href: "https://github.com/sponsors/tahamajs", target: "_blank", rel: "noreferrer", className: "contact-cta-card sponsor-cta", onClick: () => beep?.() }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-heart" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", null, "Sponsor on GitHub"), /* @__PURE__ */ React.createElement("p", null, "Fund open-source CUDA engines, Persian LLMs & AI research")), /* @__PURE__ */ React.createElement("i", { className: "fas fa-arrow-right", style: { marginLeft: "auto", opacity: 0.6 } })), /* @__PURE__ */ React.createElement("div", { className: "contact-email-row" }, /* @__PURE__ */ React.createElement("div", { className: "contact-email-display" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-envelope", style: { color: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, "tahamajlesi@ut.ac.ir")), /* @__PURE__ */ React.createElement("button", { className: "btn-secondary contact-copy", onClick: copyEmail }, copied ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("i", { className: "fas fa-check", style: { color: "var(--emerald)" } }), " Copied!") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("i", { className: "fas fa-copy" }), " Copy")))), /* @__PURE__ */ React.createElement("div", { className: "contact-social-grid" }, CONTACTS.map((c, i) => /* @__PURE__ */ React.createElement("a", { key: i, href: c.href, target: "_blank", rel: "noreferrer", className: "contact-card", onClick: () => beep?.() }, /* @__PURE__ */ React.createElement("div", { className: "contact-icon", style: { color: c.color } }, /* @__PURE__ */ React.createElement("i", { className: c.icon })), /* @__PURE__ */ React.createElement("div", { className: "contact-info" }, /* @__PURE__ */ React.createElement("span", { className: "contact-label" }, c.label), /* @__PURE__ */ React.createElement("span", { className: "contact-val" }, c.val)))))));
  }
  ...
  function GpuTelemetrySection() {
    const [history, setHistory] = (0, import_react13.useState)(() => Array(20).fill(70));
    const [flopsHist, setFlopsHist] = (0, import_react13.useState)(() => Array(20).fill(312));
    const [vram, setVram] = (0, import_react13.useState)(68.4);
    const [temp, setTemp] = (0, import_react13.useState)(62);
    const [drlReward, setDrlReward] = (0, import_react13.useState)(482);
  ...
  function AIChatModal({ open, onClose, beep, speak }) {
    const [msgs, setMsgs] = (0, import_react15.useState)([
...
${msg}`)}`;
  ...
  function CommandPalette({ open, onClose, onCmd }) {
    const [q, setQ] = (0, import_react17.useState)("");
    if (!open) return null;
...
`;
  ...
  function ArticleCreatorModal({ open, onClose, onAddArticle, beep, showToast }) {
    ...
    const [desc, setDesc] = (0, import_react19.useState)("");
    const [url, setUrl] = (0, import_react19.useState)("https://hooshaai.substack.com/p/");
    const [date, setDate] = (0, import_react19.useState)((/* @__PURE__ */ new Date()).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }));
    const [tag, setTag] = (0, import_react19.useState)("Flow Matching");
    if (!open) return null;
    const handleSubmit = (e) => {
      e.preventDefault();
  ...
  function NNPlaygroundModal({ open, onClose, beep, showToast }) {
    ...
    const [layers, setLayers] = (0, import_react20.useState)([2, 4, 4, 1]);
    const [activation, setActivation] = (0, import_react20.useState)("SiLU");
    const [lr, setLr] = (0, import_react20.useState)(0.03);
    const [dataset, setDataset] = (0, import_react20.useState)("circle");
    const [training, setTraining] = (0, import_react20.useState)(false);
    const [epoch, setEpoch] = (0, import_react20.useState)(0);
    const [loss, setLoss] = (0, import_react20.useState)(0.482);
  ...
  function PaperReaderModal({ paper, onClose, onCopyBib, beep }) {
    const [tab, setTab] = (0, import_react21.useState)("abstract");
    const mathRef = (0, import_react21.useRef)(null);
  ...
  function CyberpunkGameModal({ open, onClose, showToast, beep }) {
    ...
    const [score, setScore] = (0, import_react22.useState)(0);
    const [level, setLevel] = (0, import_react22.useState)(1);
    const [modelSize, setModelSize] = (0, import_react22.useState)("1B Params");
    const [gameOver, setGameOver] = (0, import_react22.useState)(false);
    const [gameStarted, setGameStarted] = (0, import_react22.useState)(false);
  ...
  function AlgorithmGameModal({ open, onClose, showToast, beep }) {
    const [levelIdx, setLevelIdx] = (0, import_react23.useState)(0);
    const [selectedOpt, setSelectedOpt] = (0, import_react23.useState)(null);
    const [answered, setAnswered] = (0, import_react23.useState)(false);
      ...
      const render = () => {
        ...
        if (levelIdx === 0) {
          ...
          for (let th = 0; th < 16; th++) {
            ...
            ctx.beginPath();
            ctx.arc(tx, 40, 6, 0, Math.PI * 2);
            ctx.fill();
            if (th < 8) {
              ctx.strokeStyle = "rgba(0,240,255,0.4)";
              ctx.beginPath();
              ctx.moveTo(tx, 40);
              ctx.lineTo(tx + 176, 40);
              ctx.stroke();
            }
          }
        } else {
    ...
    const handleNext = () => {
      if (levelIdx < ALGO_LEVELS.length - 1) {
        ...
        beep?.(1e3, "sine", 0.05, "chime");
        showToast?.(`\u{1F3C6} ALGORITHM MASTER CERTIFICATE EARNED! Final Score: ${score} XP`);
        setLevelIdx(0);
        setScore(0);
        setSelectedOpt(null);
        setAnswered(false);
    ...
    return /* @__PURE__ */ React.createElement(Modal, { open, onClose, wide: true }, /* @__PURE__ */ React.createElement("div", { className: "section-tag" }, "\u{1F3AE} Interactive AI Algorithm Quest"), /* @__PURE__ */ React.createElement("h2", { style: { color: "#fff", marginBottom: ".3rem", display: "flex", alignItems: "center", gap: ".6rem" } }, "AI Algorithm Quest \u{1F9EA}"), /* @__PURE__ */ React.createElement("div", { className: "algo-game-progress", style: { display: "flex", justifyContent: "space-between", alignItems: "center", margin: ".8rem 0", background: "rgba(0,0,0,0.3)", padding: ".6rem 1rem", borderRadius: "10px", border: "1px solid var(--border)" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)", fontWeight: 600, fontFamily: "monospace" } }, "Level ", levelIdx + 1, " of ", ALGO_LEVELS.length), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--emerald)", fontWeight: 700, fontFamily: "monospace", fontSize: "1.05rem" } }, "Score: ", score, " / 3000 XP")), /* @__PURE__ */ React.createElement("div", { className: "algo-game-card", style: { background: "var(--bg2)", border: "1px solid var(--border)", padding: "1.2rem", borderRadius: "14px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: ".6rem" } }, /* @__PURE__ */ React.createElement("span", { className: "algo-game-algo-badge", style: { background: "rgba(0,240,255,0.1)", color: "var(--cyan)", padding: ".25rem .7rem", borderRadius: "20px", fontSize: ".75rem", fontFamily: "monospace" } }, currentLevel.algo), /* @__PURE__ */ React.createElement("span", { style: { fontSize: ".75rem", color: "var(--muted)" } }, "Simulation Active")), /* @__PURE__ */ React.createElement("h3", { className: "algo-game-title", style: { color: "#fff", fontSize: "1.2rem", margin: ".4rem 0" } }, currentLevel.title), /* @__PURE__ */ React.createElement("p", { className: "algo-game-task", style: { color: "var(--text)", fontSize: ".9rem", lineHeight: "1.5", marginBottom: "1rem" } }, currentLevel.task), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: "1rem", background: "rgba(0,0,0,0.4)", borderRadius: "10px", padding: ".5rem", border: "1px solid var(--border)" } }, /* @__PURE__ */ React.createElement("canvas", { ref: canvasRef, style: { width: "100%", maxHeight: "140px", borderRadius: "8px" } })), /* @__PURE__ */ React.createElement("div", { className: "algo-options", style: { display: "flex", flexDirection: "column", gap: ".6rem" } }, currentLevel.options.map((opt, idx) => {
      let stateClass = "";
      if (answered) {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, fontSize: ".88rem" } }, opt.text),
        answered && (opt.correct || selectedOpt === idx) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: ".78rem", marginTop: ".4rem", color: opt.correct ? "var(--emerald)" : "#f43f5e" } }, opt.exp)
      );
      ...
      levelIdx < ALGO_LEVELS.length - 1 ? "Next Level \u2794" : "Claim Master Certificate \u{1F3C6}"
    )));
  }
  ...
  function TelegramBotModal({ open, onClose, showToast, beep }) {
    const [telegramHandle, setTelegramHandle] = (0, import_react24.useState)("");
    const [subscribed, setSubscribed] = (0, import_react24.useState)(false);
    const [topic, setTopic] = (0, import_react24.useState)("all");
    if (!open) return null;
  ...
  var TYPES = [
    "\u{1F680} AI Advisory & Consulting",
    "\u{1F393} Ph.D. / Academic Research Collaboration",
    "\u{1F4BC} Executive Recruitment & Engineering Role",
    "\u{1F4A1} 1-on-1 Technical Mentorship & Guidance"
  ];
  function BookingModal({ open, onClose, showToast, beep }) {
    const [selectedDate, setSelectedDate] = (0, import_react25.useState)("");
    const [selectedTime, setSelectedTime] = (0, import_react25.useState)(TIMESLOTS[0]);
    const [meetingType, setMeetingType] = (0, import_react25.useState)(TYPES[0]);
    ...
    const [confirmed, setConfirmed] = (0, import_react25.useState)(false);
    if (!open) return null;
    const handleBook = (e) => {
      e.preventDefault();
      ...
      beep?.(880, "sine");
      setConfirmed(true);
      showToast?.(`\u{1F4C5} Meeting Booked for ${selectedDate} at ${selectedTime}! Invitation sent to ${email}`);
...
${name}`);
    ...
    return /* @__PURE__ */ React.createElement(Modal, { open, onClose }, /* @__PURE__ */ React.createElement("div", { className: "section-tag" }, "\u{1F4C5} 1-on-1 Calendar Booking"), /* @__PURE__ */ React.createElement("h2", { style: { color: "#fff", marginBottom: ".5rem" } }, "Schedule a Meeting with Taha \u{1F91D}"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: ".88rem", color: "#cbd5e1", lineHeight: "1.6", marginBottom: "1rem" } }, "Select a date and time slot below for a direct 1-on-1 Google Meet / Zoom call with Taha Majlesi."), !confirmed ? /* @__PURE__ */ React.createElement("form", { onSubmit: handleBook, style: { display: "flex", flexDirection: "column", gap: "1rem" } }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Select Topic / Purpose:"), /* @__PURE__ */ React.createElement("select", { value: meetingType, onChange: (e) => setMeetingType(e.target.value), className: "form-input" }, TYPES.map((t, i) => /* @__PURE__ */ React.createElement("option", { key: i, value: t }, t)))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" } }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Date:"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "date",
        required: true,
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Time Slot (Tehran Time):"), /* @__PURE__ */ React.createElement("select", { value: selectedTime, onChange: (e) => setSelectedTime(e.target.value), className: "form-input" }, TIMESLOTS.map((t, i) => /* @__PURE__ */ React.createElement("option", { key: i, value: t }, t))))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" } }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Your Full Name:"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        required: true,
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Your Email Address:"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "email",
        required: true,
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Discussion Topics / Agenda Notes:"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        rows: "3",
    ...
    )), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "btn-primary", style: { justifyContent: "center", marginTop: ".5rem" } }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-calendar-check" }), " Confirm & Schedule Meeting")) : /* @__PURE__ */ React.createElement("div", { className: "telegram-success-box" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-calendar-alt", style: { fontSize: "2.5rem", color: "var(--emerald)", marginBottom: ".5rem" } }), /* @__PURE__ */ React.createElement("h3", null, "Meeting Confirmed!"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: ".85rem", color: "var(--muted)", marginTop: ".4rem", lineHeight: "1.6" } }, "A calendar invitation for ", /* @__PURE__ */ React.createElement("b", null, selectedDate), " at ", /* @__PURE__ */ React.createElement("b", null, selectedTime), " has been generated for ", /* @__PURE__ */ React.createElement("b", null, name), " (", email, "). Taha looks forward to talking with you!"), /* @__PURE__ */ React.createElement("button", { className: "btn-secondary", onClick: () => setConfirmed(false), style: { marginTop: "1rem", width: "100%", justifyContent: "center" } }, "Schedule Another Slot")));
  }
  ...
  function AuthModal({ open, onClose, onLogin, showToast, beep }) {
    ...
    const [role, setRole] = (0, import_react26.useState)("Researcher");
    if (!open) return null;
    const handleSubmit = (e) => {
      e.preventDefault();
      ...
      onLogin(user);
      beep?.(880, "sine");
      showToast?.(`\u{1F44B} Welcome ${name}! You are now signed in and connected to Taha Majlesi's AI Terminal.`);
      onClose();
    };
    return /* @__PURE__ */ React.createElement(Modal, { open, onClose }, /* @__PURE__ */ React.createElement("div", { className: "section-tag" }, "\u{1F510} Visitor Authentication"), /* @__PURE__ */ React.createElement("h2", { style: { color: "#fff", marginBottom: ".5rem" } }, "Sign In & Talk with Taha \u{1F7E2}"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: ".88rem", color: "#cbd5e1", lineHeight: "1.6", marginBottom: "1.2rem" } }, "Log in to personalize your interactive AI session, save your neural network training weights, and initiate direct priority messaging with Taha Majlesi."), /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, style: { display: "flex", flexDirection: "column", gap: "1rem" } }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Your Full Name:"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        required: true,
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("label", null, "Your Profession / Role:"), /* @__PURE__ */ React.createElement("select", { value: role, onChange: (e) => setRole(e.target.value), className: "form-input" }, /* @__PURE__ */ React.createElement("option", { value: "AI Researcher" }, "\u{1F52C} AI Researcher / Scientist"), /* @__PURE__ */ React.createElement("option", { value: "Software Engineer" }, "\u{1F4BB} Senior Software / CUDA Engineer"), /* @__PURE__ */ React.createElement("option", { value: "Recruiter" }, "\u{1F4BC} Tech Recruiter / Executive"), /* @__PURE__ */ React.createElement("option", { value: "Student" }, "\u{1F393} Student / Fellow"))), /* @__PURE__ */ React.createElement("div", { className: "auth-hope-banner", style: { background: "rgba(0,240,255,0.06)", border: "1px solid var(--border)", padding: ".8rem 1rem", borderRadius: "10px", fontSize: ".82rem", color: "var(--cyan)", lineHeight: "1.5" } }, "\u{1F4A1} ", /* @__PURE__ */ React.createElement("b", null, "Hope & Direct Connection:"), " Taha actively reads and responds to all logged-in researcher messages within 24 hours!"), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "btn-primary", style: { justifyContent: "center", marginTop: ".4rem" } }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-sign-in-alt" }), " Sign In & Start Live Session")));
  }
  ...
  // src/App.jsx
  function App() {
    const [data, setData] = (0, import_react27.useState)({ repos: [], articles: [], hf: [], readmeHtml: "" });
    const [search, setSearch] = (0, import_react27.useState)("");
    const [filter, setFilter] = (0, import_react27.useState)("all");
    const [hfFilter, setHfFilter] = (0, import_react27.useState)("all");
    const [subSearch, setSubSearch] = (0, import_react27.useState)("");
    const [userProfile, setUserProfile] = (0, import_react27.useState)(null);
    const [pageView, setPageView] = (0, import_react27.useState)("all");
    const [weatherMode, setWeatherMode] = (0, import_react27.useState)("rain");
    const [weatherAudioOn, setWeatherAudioOn] = (0, import_react27.useState)(false);
    const [accent, setAccent] = (0, import_react27.useState)("cyan");
    const [mobileNav, setMobileNav] = (0, import_react27.useState)(false);
    const [codeTab, setCodeTab] = (0, import_react27.useState)("flow");
    const [codeOut, setCodeOut] = (0, import_react27.useState)("");
    const [soundOn, setSoundOn] = (0, import_react27.useState)(false);
    const [aiOpen, setAiOpen] = (0, import_react27.useState)(false);
    const [cmdOpen, setCmdOpen] = (0, import_react27.useState)(false);
    const [hireOpen, setHireOpen] = (0, import_react27.useState)(false);
    const [cliOpen, setCliOpen] = (0, import_react27.useState)(false);
    const [nnOpen, setNnOpen] = (0, import_react27.useState)(false);
    const [gameOpen, setGameOpen] = (0, import_react27.useState)(false);
    const [shortcutsOpen, setShortcutsOpen] = (0, import_react27.useState)(false);
    const [algoGameOpen, setAlgoGameOpen] = (0, import_react27.useState)(false);
    const [telegramOpen, setTelegramOpen] = (0, import_react27.useState)(false);
    const [bookingOpen, setBookingOpen] = (0, import_react27.useState)(false);
    const [authOpen, setAuthOpen] = (0, import_react27.useState)(false);
    const [articleModalOpen, setArticleModalOpen] = (0, import_react27.useState)(false);
    const [selectedPaper, setSelectedPaper] = (0, import_react27.useState)(null);
    const [bibtexPub, setBibtexPub] = (0, import_react27.useState)(null);
    ...
    const repos = (0, import_react27.useMemo)(() => (data.repos || []).filter((r) => {
    ...
    const articles = (0, import_react27.useMemo)(() => {
      const q = subSearch.trim().toLowerCase();
      return (data.articles || []).filter((a) => !q || (a.title + a.desc).toLowerCase().includes(q));
    }, [data.articles, subSearch]);
    const hfAssets = (0, import_react27.useMemo)(() => (data.hf || []).filter((h) => hfFilter === "all" || h.type.toLowerCase() === hfFilter.toLowerCase()), [data.hf, hfFilter]);
    ...
    const counts = (0, import_react27.useMemo)(() => ({
      all: repos.length,
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Navigation, { mobileNav, setMobileNav, onHire: () => setHireOpen(true), onCmd: () => setCmdOpen(true) }), /* @__PURE__ */ React.createElement(PageRouterBar, { pageView, setPageView, beep }), /* @__PURE__ */ React.createElement(GameHUDHeader, { beep }), /* @__PURE__ */ React.createElement(FloatingContactBar, { onHire: () => setHireOpen(true), onCopyEmail: handleCopyEmail, onTelegramBot: () => setTelegramOpen(true), onBookCall: () => setBookingOpen(true), onAuth: () => setAuthOpen(true), userProfile, beep, showToast }), /* @__PURE__ */ React.createElement("main", { style: { paddingTop: "80px" } }, (pageView === "all" || pageView === "home") && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(HeroSection, { time, onHire: () => setHireOpen(true), onAI: () => setAiOpen(true), onSponsor: () => {
  ...
  root.render(/* @__PURE__ */ import_react28.default.createElement(App, null));
})();
