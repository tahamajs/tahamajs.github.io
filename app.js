...
[STATUS]   Synthetic Cognition Module is Integrated (\u03A6 > 0.0) \u2713`
  ...
  function UnlearningVis({ playing }) {
    return /* @__PURE__ */ React.createElement("div", { className: "vis-container", style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: "12px" } }, /* @__PURE__ */ React.createElement("div", { className: "vis-label" }, "Concept Subspace Null-Space Projection"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "20px", marginTop: "10px" } }, /* @__PURE__ */ React.createElement("div", { className: `matrix ${playing ? "shrink" : ""}`, style: { width: "90px", height: "60px", background: "rgba(244,63,94,0.1)", borderColor: "var(--rose)", color: "var(--rose)" } }, "W (Full)"), /* @__PURE__ */ React.createElement("div", { style: { color: "var(--accent)", fontSize: "18px" } }, "\xD7"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" } }, /* @__PURE__ */ React.createElement("div", { className: "matrix", style: { width: "100px", height: "40px", background: "rgba(0,240,255,0.1)", borderColor: "var(--cyan)" } }, "(I - U_k U_k\u1D40)"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "10px", color: "var(--muted)", fontFamily: "monospace" } }, "Null-Space Filter")), /* @__PURE__ */ React.createElement("div", { style: { color: "var(--emerald)", fontSize: "18px" } }, "="), /* @__PURE__ */ React.createElement("div", { className: "matrix", style: { width: "90px", height: "60px", background: "rgba(16,185,129,0.1)", borderColor: "var(--emerald)", color: "var(--emerald)" } }, "W_unlearned")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", color: playing ? "var(--emerald)" : "var(--muted)", fontFamily: "monospace", opacity: playing ? 1 : 0.6, transition: "all 0.5s" } }, playing ? "\u2713 Concept Erased \u2014 Retain Set Accuracy Preserved (93.8%)" : "Ready to project concept vectors onto null-space"));
  }
  function IITVis({ playing }) {
    return /* @__PURE__ */ React.createElement("div", { className: "vis-container", style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: "10px" } }, /* @__PURE__ */ React.createElement("div", { className: "vis-label" }, "IIT 4.0 Integrated Information \u03A6 Cut"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "30px", marginTop: "15px" } }, /* @__PURE__ */ React.createElement("div", { style: { border: "1px dashed var(--accent)", padding: "10px", borderRadius: "12px", background: "rgba(0,240,255,0.04)", display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "6px" } }, Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { width: "12px", height: "12px", borderRadius: "50%", background: playing ? "var(--cyan)" : "var(--muted)", boxShadow: playing ? "0 0 8px var(--cyan)" : "none", transition: "all 0.3s" } }))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "2px" } }, /* @__PURE__ */ React.createElement("div", { style: { height: "50px", width: "2px", background: playing ? "var(--rose)" : "var(--muted)", transition: "all 0.5s" } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "10px", color: playing ? "var(--rose)" : "var(--muted)", fontFamily: "monospace" } }, "MIP Cut")), /* @__PURE__ */ React.createElement("div", { style: { border: "1px dashed var(--purple)", padding: "10px", borderRadius: "12px", background: "rgba(138,43,226,0.04)", display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "6px" } }, Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { width: "12px", height: "12px", borderRadius: "50%", background: playing ? "var(--purple)" : "var(--muted)", boxShadow: playing ? "0 0 8px var(--purple)" : "none", transition: "all 0.3s" } })))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "12px", color: "var(--cyan)", fontFamily: "monospace", marginTop: "6px" } }, playing ? "\u03A6 = 2.389 bits  (System is Consciously Integrated)" : "Click Run to compute Minimum Information Partition"));
  }
