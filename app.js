(() => {
  ...
  function Navigation({ mobileNav, setMobileNav, onHire, onCmd }) {
    ...
    return /* @__PURE__ */ React.createElement("nav", { className: "glass-nav" }, /* @__PURE__ */ React.createElement("div", { className: "nav-container" }, /* @__PURE__ */ React.createElement("a", { href: "#about", className: "logo", onClick: () => setMobileNav(false) }, "Taha Majlesi ", /* @__PURE__ */ React.createElement("span", { className: "logo-badge" }, "Hoosha AI")), /* @__PURE__ */ React.createElement("div", { className: `nav-links ${mobileNav ? "open" : ""}` }, /* @__PURE__ */ React.createElement("a", { href: "#about", onClick: () => setMobileNav(false) }, "About"), /* @__PURE__ */ React.createElement("a", { href: "#telemetry", onClick: () => setMobileNav(false) }, "Telemetry"), /* @__PURE__ */ React.createElement("a", { href: "#sandbox", onClick: () => setMobileNav(false) }, "AI Lab"), /* @__PURE__ */ React.createElement("a", { href: "#constellation", onClick: () => setMobileNav(false) }, "Graph"), /* @__PURE__ */ React.createElement("a", { href: "#projects", onClick: () => setMobileNav(false) }, "Projects"), /* @__PURE__ */ React.createElement("a", { href: "#photos", onClick: () => setMobileNav(false) }, "Photos"), /* @__PURE__ */ React.createElement("a", { href: "#publications", onClick: () => setMobileNav(false) }, "Papers"), /* @__PURE__ */ React.createElement("a", { href: "#social-feed", onClick: () => setMobileNav(false) }, "X Feed"), /* @__PURE__ */ React.createElement("a", { href: "#substack", onClick: () => setMobileNav(false) }, "Substack"), /* @__PURE__ */ React.createElement("a", { href: "#experience", onClick: () => setMobileNav(false) }, "Timeline"), /* @__PURE__ */ React.createElement("a", { href: "#contact", onClick: () => setMobileNav(false) }, "Contact"), /* @__PURE__ */ React.createElement("button", { className: "nav-hire-btn", onClick: () => {
      setMobileNav(false);
      onHire();
  ...
  var PAGES = [
    ...
    { id: "photos", label: "\u{1F4F8} Moments & Photos", icon: "fas fa-camera-retro" },
  ...
  function PhotosSection({ beep }) {
    ...
    return /* @__PURE__ */ React.createElement("section", { id: "photos", className: "section fade-up" }, /* @__PURE__ */ React.createElement(
      SectionHead,
      {
        ...
        title: "Field Notes & Photo Gallery \u{1F4F8}",
        sub: "A visual glimpse into AI systems engineering, academic lectures, GPU labs, and research journeys."
      }
    ), /* @__PURE__ */ React.createElement("div", { className: "photo-filters" }, CATEGORIES.map((cat) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: cat,
      ...
      /* @__PURE__ */ React.createElement("div", { className: "photo-img-wrap" }, /* @__PURE__ */ React.createElement(
        "img",
        {
          src: p.src,
          alt: p.title,
